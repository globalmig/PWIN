...
const historyList = [
  ...
  { key: 2, index: 1, year: "1990/08", title: "벽돌, 블록 유압식 자동화 생산설비 구축", img: "/images/main/회사연혁_1990.08.jpg" },
  { key: 3, index: 2, year: "1992/08", title: "KS F 4004 한국산업규격 표시인증 (인증번호: 제9301호)", img: "/images/certificate/certificates(9).webp" },
  { key: 4, index: 3, year: "2007/02", title: "우수제품(GQ)마크 인증 (인증번호: 제 건재-380호)", img: "/images/main/회사연혁_2007.02.jpg" },
  { key: 5, index: 4, year: "2007/02", title: "품질인증(건)마크 인증 (인증번호: 2007-16)", img: "/images/certificate/certificates(10).webp" },
  { key: 6, index: 5, year: "2007/03", title: "KS F 4002 한국산업규격 표시인증 (인증번호: 제 07-0109호)", img: "/images/certificate/certificates(7).webp" },
  ...
  { key: 11, index: 10, year: "2023~현재", title: "'평스톤'상표 및 제품 디자인 특허 등록", img: "/images/main/회사연혁_2023~현재.jpg" },
];
