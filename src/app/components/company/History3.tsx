...
const historyList = [
  ...
  { key: 7, index: 6, year: "2016/04", title: "보강토 옹벽블록 전용 자동화 생산설비 구축 (1호기)", img: "/images/main/type01/2.webp" },
  { key: 8, index: 7, year: "2016/10", title: "콘크리트 호안 및 옹벽블록 단체표준 표시인증 (인증번호: 제470호)", img: "/images/certificate/certificates(11).webp" },
