...
${selectedBlock === item.type ? "bg-[#3A7D44] text-white text-3xl" : "bg-white text-black"}`}
              ...
              >
                <div className={`absolute transform duration-700 ease-in-out ${selectedBlock === item.type ? "-top-20 md:-top-32" : "-top-16 md:-top-28"}`}>
                  <Image
                    src={item.img}
                    alt={item.alt}
                    width={160}
                    height={160}
                    className={`transform duration-700 ease-in-out w-[100px] md:w-[160px] ${selectedBlock === item.type ? "w-[140px] md:w-[180px]" : "w-[120px] md:w-[170px]"}`}
                  />
                </div>
